...
void main() {
  group('CirclePacker - Minimum Radius', () {
    test('should enforce minRadius for very small values', () {
      final root = CircleNode(label: 'Root', children: [
      ...
      final packedRoot = CirclePacker.pack(root, radius: 100.0, minRadiusRatio: 0.2);
      
      final big = packedRoot.children.firstWhere((c) => c.node.label == 'Big');
      final tiny = packedRoot.children.firstWhere((c) => c.node.label == 'Tiny');
