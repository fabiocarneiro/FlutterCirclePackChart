      ...
      children: [
        CircleNode(
          ...
          children: [
            ...
            CircleNode(label: 'Utilities', secondaryLabel: '\$250', value: 250.0),
            CircleNode(label: 'Insurance', secondaryLabel: '\$200', value: 200.0),
            CircleNode(label: 'Transport', secondaryLabel: '\$150', value: 150.0),
          ],
        ),
        CircleNode(
          label: 'Wants',
          ...
          children: [
            ...
            CircleNode(label: 'Subs', secondaryLabel: '\$50', value: 50.0),
            CircleNode(label: 'Shopping', secondaryLabel: '\$200', value: 200.0),
            CircleNode(label: 'Hobbies', secondaryLabel: '\$150', value: 150.0),
            CircleNode(label: 'Travel', secondaryLabel: '\$400', value: 400.0),
          ],
        ),
        CircleNode(
          label: 'Savings',
          ...
          color: Colors.teal,
          children: [
            CircleNode(label: 'Emergency', secondaryLabel: '\$500', value: 500.0),
            CircleNode(label: 'Retire', secondaryLabel: '\$400', value: 400.0),
            CircleNode(label: 'Invest', secondaryLabel: '\$300', value: 300.0),
            CircleNode(label: 'Debt', secondaryLabel: '\$200', value: 200.0),
          ],
        ),
      ],
    );
