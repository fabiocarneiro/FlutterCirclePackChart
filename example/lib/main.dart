    ...
    final root = CircleNode(
      ...
      children: [
        CircleNode(
          ...
          color: Colors.orange,
          children: [
            CircleNode(label: '\$1500\nRent', value: 1500.0),
            CircleNode(label: '\$400\nGroceries', value: 400.0),
            CircleNode(label: '\$250\nUtilities', value: 250.0),
            CircleNode(label: '\$200\nInsurance', value: 200.0),
            CircleNode(label: '\$150\nTransport', value: 150.0),
          ],
        ),
        CircleNode(
          label: '\$1100\nWants',
          color: Colors.pink,
          children: [
            CircleNode(label: '\$300\nDining', value: 300.0),
            CircleNode(label: '\$50\nSubs', value: 50.0),
            CircleNode(label: '\$200\nShopping', value: 200.0),
            CircleNode(label: '\$150\nHobbies', value: 150.0),
            CircleNode(label: '\$400\nTravel', value: 400.0),
          ],
        ),
        CircleNode(
          ...
          color: Colors.teal,
          children: [
            CircleNode(label: '\$500\nEmergency', value: 500.0),
            CircleNode(label: '\$400\nRetire', value: 400.0),
            CircleNode(label: '\$300\nInvest', value: 300.0),
            CircleNode(label: '\$200\nDebt', value: 200.0),
          ],
